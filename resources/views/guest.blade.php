...
@section('content')
{{-- hero section --}}
<section id="guest-hero" class="d-flex justify-content-center align-items-center" style="background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('{{ asset('backgrounds/hero-background.jpg') }}') center/cover ;" >
...
{{-- slogan section --}}
<section id="slogan" class="d-flex justify-content-center align-items-center bg-body-secondary" style="height: 30vh" >
    <div class="container">
        <div class="text-center py-4" >
...
<section id="best-selling" class="d-flex flex-column justify-content-center" style="height: 70vh" >
    <div class="container ">
        <div class="text-center py-4" >
            <h2>Best Selling !</h2>
        </div>
        <div class="row p-4" >
            <div class="col-md-4 col-sm-6 mb-4" >
                ...
                <a href="">
                    <img src="{{ asset('sample/square-product.png') }}" class="img-fluid"  alt="">
                </a>
            </div>
            <div class="col-md-4 col-sm-6 mb-4" >
                {{-- style="max-width: 350px; min-width: 10%;" --}}
